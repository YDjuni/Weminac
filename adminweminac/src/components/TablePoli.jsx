...
export default function Poli() {
  ...
  const handleDelete = (e, id) => {
    ...
    axios
      .delete(`http://localhost:8000/api/polis/${id}`)
      .then((res) => {
            ...
            <div className="">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Tabel Poli</h5>
                  {/* Default Table */}
                    ...
                    <thead>
                      ...
                      {data.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>{item.desc}</td>
                          <td>
                            <Link to={`/poli/${item.id}/edit`} className="btn btn-warning" role="button">Update</Link>
