...
export default function UpdateLayanan() {
    ...
    const uploadProduct= async()=>{
        ...
        const response= await axios.post("http://127.0.0.1:8000/api/layanans/"+id, formData, {
            headers:{'Content-Type':"multipart/form-data"},
        } );
        setMessage(response.data.message); //"message": "Product successfully updated.."
        console.log(response)
        alert("Data Layanan Berhasil Di Update")
        setTimeout(()=>{
            navigate('/layanan');
        }, 2000);
    }
    ...
    function getlayanan() {
        axios.get('http://127.0.0.1:8000/api/layanan/'+id).then(function(response) {
            console.log(response);
            ...
            <div className="">
              <div className="card">
                <div className="card-body mb-4">
                  <h5 className="card-title">Update Data Layanan</h5>
